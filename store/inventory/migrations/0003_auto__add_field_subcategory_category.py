...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'inventory_subcategory', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Category'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubCategory.category'
        db.delete_column(u'inventory_subcategory', 'category_id')
