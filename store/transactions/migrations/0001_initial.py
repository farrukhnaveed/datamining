...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'transactions_transactionitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=10)),
        ))
        db.send_create_signal(u'transactions', ['TransactionItem'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'transactions_transactionitem')
    ...
    models = {
        ...
        u'transactions.transactionitem': {
            'Meta': {'object_name': 'TransactionItem'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Item']"}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'max_length': '10'}),
